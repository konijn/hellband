...
/*
* OPTION: Allow "do_cmd_colours" at run-time
*/
#define ALLOW_COLORS
...
* needed, saving ~1K, since "artefact" descriptions are unused.
*/
...
/*
* OPTION: Allow the use of "transparency" in graphics
*/
...
/*
* OPTION: Attempt to prevent all "Debugging"
*/
/* #define VERIFY_HONOR */
